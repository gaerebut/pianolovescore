	...
	<div class="col-md-8 col-md-offset-2">
		<form action="{{ route('admin_scores_edit_store') }}" method="post" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<textarea id="description_fr" name="description_fr">{{ $score->description_fr }}</textarea>
				</div>
			</div>
			<div class="form-group">
				<label for="description_en" class="col-sm-2 control-label">Description EN</label>
				<div class="col-sm-10">
					<textarea id="description_en" name="description_en">{{ $score->description_en }}</textarea>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="score_image" name="score_image" placeholder="http://www.nouvelleimage.com/miniature.png">
