        ...
        <div class="col-sm-offset-2 col-sm-8">
            ...
            <form action="{{ route('score_request_submit') }}" method="post" class="form-horizontal request">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" name="contact_email"  id="contact_email" value="{{ old('contact_email') }}" placeholder="Exemple : jean.hebert@hotmail.com" required /><i>Vous serez informé par email lorsque votre demande sera traitée.</i>
                    </div>
                </div>
                <div class="form-group">
